...
public class FurnitureSchemeController {
    ...
    public ApiResponse<FurnitureSchemeResponse> createScheme(
        ...
        CreateFurnitureSchemeRequest createRequest = new CreateFurnitureSchemeRequest();
        createRequest.setRoomId(roomId);

        Long designerId = jwtUtil.getUserId(request);
        FurnitureScheme scheme = schemeService.createScheme(designerId, createRequest, file);
    ...
    public ApiResponse<FurnitureSchemeResponse> updateSchemeImage(
        ...
        Long designerId = jwtUtil.getUserId(request);
        FurnitureScheme scheme = schemeService.updateSchemeImage(schemeId, file, designerId);
        return ApiResponse.success(FurnitureSchemeResponse.toDTO(scheme));
    }
